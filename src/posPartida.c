...
void resumenPartida(jugador *jugadores, int tam_tablero) {
    ...
    printf("| Jugador1   |   %4d  |  %4d | %3d |   %4d |    %4d |    %4d |  %4d |    %1d   |\n",
           jugadores[0].Num_Disparos, vacias1, agua1, tocadas1, hundidas1, contar_hundidos_jugador(&jugadores[0], tam_tablero) , jugadores[1].Num_Barcos, jugadores[0].Ganador_Ronda);
    printf("| Jugador2   |   %4d  |  %4d | %3d |   %4d |    %4d |    %4d |  %4d |    %1d   |\n",
           jugadores[1].Num_Disparos, vacias2, agua2, tocadas2, hundidas2, contar_hundidos_jugador(&jugadores[1], tam_tablero) , jugadores[0].Num_Barcos,jugadores[1].Ganador_Ronda);
